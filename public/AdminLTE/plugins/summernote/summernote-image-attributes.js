    ...
    'imageAttributes': function (context) {
      ...
      this.initialize = function () {
        ...
        var body = '<ul class="nav note-nav nav-tabs note-nav-tabs">' +
                   /*   '<li class="nav-item note-nav-item">' +
          '<a class="nav-link note-nav-link active" onclick="openTab(' + i + ')" data-bs-toggle="tab">' + lang.imageAttributes.tabImage + '</a>' +
          '</li>' +*/
                      '<li class="nav-item note-nav-item active"><a class="nav-link note-nav-link" onclick="openTab(' + i + ')" data-bs-toggle="tab">' + lang.imageAttributes.tabAttributes + '</a></li>'
...
// Tab 2
                    ...
                    '</div>' +
// Tab 3
                    '<div class="tab-pane note-tab-pane active" id="note-imageAttributes-link-' + i + '">' +
...
// Tab 1
        body +=     '<div class="tab-pane note-tab-pane " id="note-imageAttributes-' + i + '">' +
